    ...
    levels: {
      ...
      levelKitty: {
        ...
        levelQuestions: [
          ...
          },
          {
            ...
            answer: 3,
            curiousFact:
              "Los gatos son depredadores ágiles y pueden alcanzar velocidades sorprendentes en distancias cortas gracias a su potente musculatura",
          },
          {
      ...
      levelRaces: {
        ...
        levelQuestions: [
          ...
          {
            title:
              "¿Cuál de las siguientes razas de gatos es conocida por sus patas polydactyl, es decir, con más dedos de lo normal?",
            answers: [
              "A) Manx.",
              "B) Persian.",
              "C) Ragdoll.",
            ...
            answer: 0,
            curiousFact:
              "Los gatos Manx son famosos por tener patas con un mayor número de dedos que la mayoría de las razas, lo que les da una apariencia única. Algunos incluso pueden tener hasta siete dedos en una pata. Son conocidos por ser gatos robustos y activos.",
          },
          {
            title:
          ...
          },
          {
            ...
            answer: 3,
            curiousFact:
              "Los gatos Cornish Rex tienen un pelaje rizado y suave que se asemeja al terciopelo. Además de su pelaje único, tienen orejas pequeñas y dobladas hacia adelante. Son gatos juguetones y enérgicos.",
          },
          {
            title:
      ...
      levelMaster: {
        ...
        levelQuestions: [
          ...
          {
            title:
              "¿Qué parte del gato es conocida como 'galera' y se encuentra en el cuello?",
            answers: ["A) Grupa.", "B) Pecho.", "C) Manto.", "D) Cuello."],
            answer: 2,
            curiousFact:
